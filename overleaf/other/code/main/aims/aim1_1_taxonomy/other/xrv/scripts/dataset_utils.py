...
def get_data(dataset_str, masks=False, unique_patients=False, transform=None, data_aug=None, merge=True, views = ["PA","AP"], pathologies=None):

    dataset_dir = "/Users/personal-macbook/Documents/PhD/code/my_main_code/main/datasets/" # "/home/groups/akshaysc/joecohen/"
