...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/image1.png}\label{crowd.Fig.1.weight}
...
\begin{figure*}[!htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/image2.png}\label{crowd.Fig.2.confidence_scores}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/image4.png}\label{crowd.Fig.4.confidence_score.freq}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/image7.png}\label{crowd.Fig.5.confidencescore-beta}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/image8.png}\label{crowd.Fig.6.accuracy}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/image9.png}\label{Fig.6-accuracy-different-n-annotators}
...
\begin{figure*}[!htbp]
    \centering \includegraphics[width=\textwidth]{figures/image10.png}\label{Fig.7-accuracy-different-datasets}
