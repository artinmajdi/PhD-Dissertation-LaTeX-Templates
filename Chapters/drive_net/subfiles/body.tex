...
Distracted driving is a major cause of motor vehicle accidents. Each day in the United States, approximately 9 people are killed, and more than 1000 are injured in crashes that involve a distracted driver~\cite{schroeder_National_2018}. It is estimated that about 25\% of fatalities in motor vehicle accidents are due to distracted driving~\cite{website_insurer_2013}. A study of American motor vehicle fatalities~\cite{schroeder_National_2018} reveals the top 10 causes of distracted driving (shown in Table~\ref{tab:drivenet.introStats}).

\begin{table}[h]
    \centering
    \caption{Distribution of Distractions among Drivers}\label{tab:drivenet.introStats}
    \begin{tabularx}{0.8\linewidth}{@{} X r @{}}
        ...
        Other occupants & 5\% \\
        Using or reaching for a device (e.g., phone) & 2\% \\
        Eating or drinking & 2\% \\
        Adjusting audio or climate controls & 2\% \\
        Using devices to operate the vehicle (e.g., adjusting mirrors or seatbelts) & 1\% \\
        Moving objects (e.g., insects or pets) & 1\% \\
        Smoking related & 1\% \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{multicols}{2}[t]
    ...
    \centering
    \captionof{table}{Error Count of Each Class for the Neural Network Methods}%
...
\columnbreak%
    ...
    \centering
    \captionof{table}{Mean Classification Accuracy of the Automated Methods}%
