...
\noindent % Ensures no indentation for this block
\begin{minipage}{0.4\textwidth}
    \centering
    \captionof{table}{Performance of the Classification Algorithms}
...
\begin{minipage}{0.4\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{\figurepath{fig3}}
    \captionof{figure}{ROC curves for various classification methods.}
