...
% \includegraphics[page=1, width=\textwidth]{Chapters/crowd/crowd_presentation_slides.pdf}
...
% \includegraphics[page=3, width=\textwidth]{Chapters/crowd/crowd_presentation_slides.pdf}
...
% \includegraphics[page=2, width=\textwidth]{Chapters/crowd/crowd_presentation_slides.pdf}
...
% \includegraphics[page=4, width=\textwidth]{Chapters/crowd/crowd_presentation_slides.pdf}
...
% \includegraphics[page=5, width=\textwidth]{Chapters/crowd/crowd_presentation_slides.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{\figurepath{figure_metrics_mean_over_seeds_per_dataset_per_worker_ACC/figure_metrics_mean_over_seeds_per_dataset_per_worker_ACC.pdf}}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{\figurepath{figure_heatmap_F_evals_kr-vs-kp_all_labelers/figure_heatmap_F_evals_kr-vs-kp_all_labelers.pdf}}
    % \captionsetup{width=0.8\textwidth}
    \caption[ECE and Brier Score Comparison across Techniques for Varying Number of Workers for kr-vs-kp Dataset]{This figure presents a comparative evaluation of the \textcolor{orange}{ECE} and the \textcolor{blue}{Brier Score} across two confidence score measurement strategies: Beta ($F_{\beta}$) and Freq ($F_{\Omega}$). The results are plotted for three distinct label aggregation techniques: Crowd-Certain, Tao, and Sheng, on the kr-vs-kp dataset with varying numbers of crowd workers from three to seven (NL3 to NL7). }\label{fig:crowd.Fig.confidence_score_one_datasets_all_workers}
\end{figure}
