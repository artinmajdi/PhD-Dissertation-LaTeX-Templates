...
\abstract{
        ...
        Additionally, we introduce a variation of two existing confidence score measurement techniques. Finally, we evalute these two confidence score techniques using two evaluation metrics: Expected Calibration Error (ECE) and Brier Score Loss.
