...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{\figurepath{image1.png}}\label{crowd.Fig.1.weight}
...
\begin{figure*}[!htbp]
\centering
\includegraphics[width=0.8\textwidth]{\figurepath{image2.png}}\label{crowd.Fig.2.confidence_scores}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{\figurepath{image4.png}}\label{crowd.Fig.4.confidence_score.freq}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{\figurepath{image7.png}}\label{crowd.Fig.5.confidencescore-beta}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{\figurepath{image8.png}}\label{crowd.Fig.6.accuracy}
...
\begin{figure*}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{\figurepath{image9.png}}\label{Fig.6-accuracy-different-n-annotators}
...
\begin{figure*}[!htbp]
    \centering \includegraphics[width=\textwidth]{\figurepath{image10.png}}\label{Fig.7-accuracy-different-datasets}
