...
Figure~\ref{fig:taxonomy.fig.2.metrics} shows the comparison of the proposed ``logit'' and ``loss' techniques vs. baseline for AUC, Accuracy and F1 scores.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{\figurepath{ROC/fig_metrics_AUC_ACC_F1/metrics_AUC_ACC_F1.pdf}}
    \caption{Comparison of proposed ``logit'' and ``loss' techniques vs. baseline for AUC, Accuracy and F1 scores}%
    \label{fig:taxonomy.fig.2.metrics}
\end{figure}

Table~\ref{tab:taxonomy.table.3.metrics} presents the comparison of the performance of our proposed techniques "Logit" and "Loss" against the "Baseline" technique for a series of medical conditions related to lung and heart diseases. 
